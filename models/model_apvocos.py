...
class APBWE_periodic(torch.nn.Module):
    def __init__(self, h, **kwargs):
        super(APBWE_periodic, self).__init__()
        self.h = h
        ...
        self.linear_post_pha = nn.Linear(h.ConvNeXt_channels, h.n_fft//2+1)
    ...
    def forward(self, mag_nb, pha_nb, cond_mag):
        ...
        pha_wb = self.linear_post_pha(x_pha).transpose(1,2) # before wrapping
        ...
        # pha_wb = torch.atan2(x_pha_i, x_pha_r).transpose(1, 2) # wrap into [-pi, pi]
